    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', '正常'), ('disabled', '已禁用'), ('locked', '已锁定'), ('pending_delete', '待注销'), ('deleted', '已删除')], default='active', max_length=24, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('provider', models.CharField(choices=[('wechat_mini_program', '微信小程序')], max_length=40)),
                ('provider_app_id', models.CharField(max_length=100)),
                ('provider_subject', models.CharField(max_length=160)),
                ('unionid', models.CharField(blank=True, max_length=160)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('provider', 'provider_app_id', 'provider_subject'), name='uniq_identity_provider_app_subject')],
            },
        ),
    ]
